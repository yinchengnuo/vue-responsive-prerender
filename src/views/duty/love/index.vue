      ...
      <div class="time">
        ...
        <div class="content">
          <div class="item">
            ...
            <div class="month">春</div>
            <div class="circle" />
            <div class="text">第一季《爱的守望》感统指导公益行出发，在河北走入多组家庭，面对面帮助20余位孩子进行感统测评，并指导家长如何科学育儿，杜绝感统失调。</div>
          </div>
          <div class="item">
            <div class="year">2018年</div>
            <div class="month">冬</div>
            <div class="circle" />
            <div class="text">第二季《爱的守望》感统指导公益行先后赴北京、天津、山东等地，帮助近百位孩子找到感统失调原因，并为家长带去感统训练课程和教具，让孩子能够更好更快回归正常生长发育。</div>
          </div>
          <div class="item">
            <div class="year">2020年</div>
            <div class="month">9月</div>
            <div class="circle" />
            <div class="text">老岳讲感统向北京市慈善基金会教育工程专项基金捐赠105000元，用以“让特殊儿童融入社会”公益项目。</div>
          </div>
          <div class="item">
            <div class="year">2020年</div>
            <div class="month">10月</div>
            <div class="circle" />
            <div class="text">老岳讲感统组建公益行团队，第三季《爱的守望》感统指导公益行出发，同时作为“让特殊儿童融入社会”公益项目的重要活动，先后走过河南、山西、河北、山东、合肥、江苏、浙江、湖北等地，帮助300多组家庭。</div>
          </div>
        </div>
      </div>
    </div>
          ...
          <slider ref="swiper2" class="swiper" :options="swiper2" @slide="({ currentPage }) => $refs.swiper1.$emit('slideTo', currentPage)">
            <slideritem v-for="(item, index) in list" :key="index">
              <div class="item">
                ...
                <div class="text">{{ item.text | slice(78) }}</div>
              </div>
            </slideritem>
          </slider>
        </div>
